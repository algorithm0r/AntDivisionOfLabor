...
function Tile(game, xPos, yPos) {
	...
	this.drawMyself = (this.xPos % (DRAW_TILE_ABSTRACT) == 0)
		&& (this.yPos % (DRAW_TILE_ABSTRACT) == 0)
	//similar to myDrawShare for ants, this is used to decide how many tiles to draw.
	//except it draws a fixed set.
...
Tile.prototype.draw = function() {
	if(this.drawMyself) {
			//DRAW_PORTION is used to decide how often to draw each tile.
